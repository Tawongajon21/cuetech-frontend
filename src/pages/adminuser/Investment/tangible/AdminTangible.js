...
const Admintangible = () => {
    ...
    const getTangible = () => {
        axios.get(`investment/tangible/all/${id}/`, config())
            .then(res => {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className='text-center'>
                                                                <div className='button-group'>
                                                                    <Link to={{ pathname: `/adminuser/farmers/tangible/update/${tan.id}/${id}` }} className="btn btn-sm btn-info mr-2"> <i className="fa fa-edit"></i></Link>
