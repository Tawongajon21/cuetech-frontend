...
const Addplantsdata = () => {
    ...
    const addPlantsData = (e) => {
        e.preventDefault()
        const url = `operations/plants/info/create/`;
        postData(url, plantsdata).then((data) => {
    ...
    return (
        <div className="wrapper">
            ...
            <div className="content-wrapper">
                <ContentHeader title="Add Plants Data" />
