...
const Addplantsotherexpenses = () => {
    ...
    const addPlantsOtherExpense = (e) => {
        e.preventDefault()
        const url = `operations/plants/otherexpenses/create/`;
        postData(url, plantsotherexpense).then((data) => {
    ...
    return (
        <div className="wrapper">
            ...
            <div className="content-wrapper">
                <ContentHeader title="Add Plants Other Expenses" />
                            ...
                            <div className='col-md-12 mb-2'>
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        <form onSubmit={addPlantsOtherExpense}>
                                            <div class="row">
...
export default Addplantsotherexpenses;
