...
const Adminaddlivestock = () => {
    ...
    const addLivestock = (e) => {
        e.preventDefault()

        axios.post("operations/livestock/create/", livestock, config())
            .then(res => {
                console.log(res.data)
                res.data.response === 1 ? navigate(`/adminuser/farmers/livestock/${id}`) : alert(res.data.message)
            })
            .catch(err => {
                alert(ERROR_MESSAGE)
            })
        ...
        return (
            <div className="wrapper">
                ...
                <div className="content-wrapper">
                    <ContentHeader title="Add Livestock" />
                                    ...
                                    <div className="card-header">
                                        <div className='row'>
                                            ...
                                            <div className='col-md-6 float-right'>
                                                <Link to={{ pathname: `/adminuser/farmers/livestock/${id}` }} className="btn btn-sm btn-primary float-right"><i class="fa fa-arrow-left"></i> Go Back</Link>
                                            </div>
                                        </div>
                                    </div>
...
export default Adminaddlivestock;
