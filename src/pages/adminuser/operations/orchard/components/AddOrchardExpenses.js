...
const Addorchardsexpenses = () => {
    const { id, uid } = useParams()
    const navigate = useNavigate()
    const [orchardsdataexpense, setorchardsdataexpense] = useState({
        item: "N/A",
        name: "N/A",
        cost: "N/A",
        quantity_bought: "N/A",
    ...
    const url = `operations/orchards/expenses/create/`;
    const addOrchardsdataExpense = (e) => {
        e.preventDefault()
        postData(url, orchardsdataexpense).then((data) => {
    ...
    return (
        <div className="wrapper">
            ...
            <div className="content-wrapper">
                <ContentHeader title="Add Orchards Expense" />
                            ...
                            <div className='col-md-12 mb-2'>
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        <form onSubmit={addOrchardsdataExpense}>
                                            <div class="row">
...
export default Addorchardsexpenses;
